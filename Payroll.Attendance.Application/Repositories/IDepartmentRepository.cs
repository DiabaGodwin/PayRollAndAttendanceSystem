...
public interface IDepartmentRepository
{
    ...
    Task<List<Department>> GetAllDepartmentsAsync( bool includeEmployees = false, CancellationToken cancellationToken = default);
    Task<List<Department>> GetAllOnlyDepartmentsAsync( CancellationToken cancellationToken = default);

    Task<Department?> GetDepartmentByIdAsync(int id, bool includeEmployee = false,
