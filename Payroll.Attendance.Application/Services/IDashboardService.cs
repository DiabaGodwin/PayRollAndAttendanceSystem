...
public interface IDashboardService
{
    ...
    Task<ApiResponse<List<AttendanceTrendDto>>> GetAttendanceTrendAsync(DateTime startDate, DateTime endDate,
        CancellationToken cancellationToken);
  ...
  //  Task<ApiResponse<FullDashboardResponseDto>> GetFullDashboardAsync(
    //    CancellationToken cancellationToken);
    Task<ApiResponse<List<AuditTrail>>> GetActivityAsync(CancellationToken cancellationToken);
